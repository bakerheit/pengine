# Vellum network and density pass
...
south endpoint of Vellum Row at the shared 13.5 m datum. Rook Lane keeps its
...
| Tower | Vellum grid centre | Floors | Use | Crown |
|---|---:|---:|---|---|
...
blocks. They reuse the bounded Vellum infill system, including shopfronts,
...
- The road graph contains both requested connections and a real production
  vehicle drives Nickel Road to Halloway Street and the North Arm to Vellum Row
  without sinking.
...
- All 12 infill parcels remain on the 12 m Vellum datum and clear road ribbons.
