...
- Resolve the existing engine-profile uniqueness test failure: multiple cars currently share a pitch. Other final suites pass, including corrected eight-vehicle-role plus city-ambience asset counts.
