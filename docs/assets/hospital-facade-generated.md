# Pinatty hospital generated facade asset
...
- Project asset:
  `assets/textures/world/hospital/facade/pinatty-main-entry-mural-face-generated.png`
...
`PINATTY REGIONAL HOSPITAL` once, and there are no added words, real brands,
...
Asset type: project-bound fitted facade texture for the single authored plane named "hospital main entry mural face", a 9.0 m wide by 6.0 m high north-facing plane on Pinatty Regional Hospital
...
Text (verbatim): "PINATTY REGIONAL HOSPITAL"
