...
Primary request: create a single flat, front-facing rectangular hospital wayfinding sign panel for Pinatty Regional Hospital, designed as a readable low-resolution PSX-era open-world game texture
...
Text (verbatim): "PINATTY REGIONAL HOSPITAL" on row 1, "VISITOR PARKING ↑" on row 2, "AMBULANCES →" on row 3
