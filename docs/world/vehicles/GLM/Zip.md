...
| Vehicle role | compact targa sports car |
| In-game mass | 1,180 kg |
...
- Model key: `glm_zip`.
- Body: `assets/models/vehicles/glm_zip/body_surface.emesh`.
- Texture: `assets/textures/vehicles/glm_zip/body_surface.png`.
- Selection: **F1 → Vehicle → Choose Car → GLM → Zip**.
