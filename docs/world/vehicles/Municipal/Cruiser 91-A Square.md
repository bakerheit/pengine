# Municipal Cruiser 91-A Square

[Vehicles](../README.md) · [Municipal](../Municipal.md)

Square, heavy fleet sedan.

## Images

![Municipal Cruiser 91-A Square — model preview sheet](../images/municipal-cruiser-91a.png)
...
| Model | Cruiser 91-A Square |
| Status | Selectable in the game catalog |
| Vehicle role | square, heavy fleet sedan |
| In-game mass | 1,825 kg |
...
- Model key: `municipal_cruiser_91a`.
- Body: `assets/models/vehicles/municipal_cruiser_91a/body.emesh`.
- Texture: `assets/textures/vehicles/municipal_cruiser_91a/body.png`.
- Selection: **F1 → Vehicle → Choose Car → Municipal → Cruiser 91-A Square**.
