...
inline std::vector<StartPart> bake_hospital_detail_surfaces() {
    ...
    constexpr Vec2 light_points[] = {
        {-9.0f, 10.0f}, {0.0f, 1.0f}, {0.0f, 20.0f},
        {14.0f, 15.0f}, {23.0f, 22.0f}, {36.0f, 8.0f}, {35.0f, 20.0f},
        {78.0f, 4.0f}, {75.0f, 22.0f}, {85.0f, 22.0f}, {104.0f, 20.0f},
        {60.0f, 3.0f}, {60.0f, 30.0f}, {100.0f, 12.0f},
        {-6.75f, 108.0f}, {-0.25f, 108.0f}, {6.25f, 108.0f}, {12.75f, 108.0f},
        {-5.0f, 114.0f}, {8.0f, 114.0f}, {23.0f, 114.0f}, {22.0f, 108.0f},
        {40.0f, 47.0f}, {40.0f, 70.0f}, {40.0f, 89.0f}, {40.0f, 114.0f},
        {159.0f, 68.0f}, {169.0f, 68.0f}, {159.0f, 90.0f},
        {161.0f, 79.0f}, {187.0f, 79.0f}, {177.0f, 48.0f}, {177.0f, 99.0f},
        {194.0f, 12.0f}, {160.0f, 4.0f}, {145.0f, 12.0f},
        {60.0f, 69.0f}, {94.0f, 69.0f}, {130.0f, 69.0f},
        {60.0f, 117.0f}, {94.0f, 117.0f}, {130.0f, 117.0f},
    };
