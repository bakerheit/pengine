...
inline constexpr District kDistricts[] = {
    ...
    {.id = DistrictId::OstendDocks,
     ...
     .boundary = {.points = {{-2430.0f, -1050.0f},
                             {-1380.0f, -980.0f},
                             {-1300.0f, -300.0f},
                             {-1900.0f, -170.0f},
                             {-2470.0f, -520.0f}},
    ...
    {.id = DistrictId::KeplerFlats,
     ...
     .boundary = {.points = {{-1290.0f, -1980.0f},
                             {-120.0f, -2030.0f},
                             {180.0f, -1520.0f},
                             {-440.0f, -1380.0f},
                             {-1200.0f, -1450.0f}},
    ...
    {.id = DistrictId::TheStrand,
     ...
     .boundary = {.points = {{1360.0f, 480.0f},
                             {1900.0f, 620.0f},
                             {1780.0f, 1560.0f},
                             {1380.0f, 1960.0f},
                             {1160.0f, 1500.0f},
    ...
    {.id = DistrictId::CamberPoint,
     ...
     .boundary = {.points = {{-360.0f, 1880.0f},
                             {780.0f, 1830.0f},
                             {900.0f, 2280.0f},
                             {170.0f, 2450.0f},
                             {-390.0f, 2210.0f}},
    ...
    {.id = DistrictId::Marrow,
     ...
     .boundary = {.points = {{-2360.0f, 1020.0f},
                             {-1280.0f, 960.0f},
                             {-1130.0f, 1740.0f},
                             {-1790.0f, 2060.0f},
                             {-2350.0f, 1670.0f}},
