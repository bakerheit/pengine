...
inline constexpr std::array<VehicleWindshieldProfile,37> kVehicleWindshields{{
    ...
    // Same screen: car5_next shares Car 5's cooked shell, cut not remodelled.
    {"car5_next",1.04f,1.50f,1.96f,1.23f,.575f,.13f},
    // Same screen again: the patrol car is car5_next plus paint and a lightbar.
    {"car5_next_police",1.04f,1.50f,1.96f,1.23f,.575f,.13f},
    ...
    {"pizaz_constant",.643f,.90f,1.24f,.25f,.88f,.06f},
    ...
    {"harrow_rearloader",1.018f,2.058f,3.010f,3.578f,3.362f},
