...
// tests/terrain_determinism_tests.cpp, which is engine-only and was likewise
// unaffected by the rally coming out. The clash is reported on PENG-22; it is
// a real defect in src/, not a test-side inconvenience.
