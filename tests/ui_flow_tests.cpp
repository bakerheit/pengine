...
void developer_menu_navigates_and_returns_a_teleport() {
    ...
    REQUIRE(std::strcmp(menu.item_label(1), "MERIDIAN") == 0);
    REQUIRE(std::strcmp(menu.item_label(2), "ZIP") == 0);
    ...
    menu.set_selection(1);
    REQUIRE(menu.update(kBtnAccept).player_car == PlayerCarId::GlmMeridian);
    menu.set_selection(2);
    ...
    menu.set_selection(2);
    REQUIRE(std::strcmp(menu.item_label(2), "HOOKLINE") == 0);
    REQUIRE(menu.update(kBtnAccept).player_car == PlayerCarId::HarrowHookline);
