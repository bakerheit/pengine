...
REGIONS={'paint':(0,0,256,128),'darkPaint':(0,128,64,192),'trim':(64,128,128,192),
 'upholstery':(128,128,192,160),'leather':(128,160,192,176),'carpet':(128,176,192,192),
 'glass':(192,128,208,144),'instruments':(192,144,256,176),'radio':(208,128,240,144),
 'hvac':(192,176,224,192),'speaker':(224,176,256,192),'selector':(240,128,256,144),'silver':(0,192,64,256),
...
COLORS.update(carpet=(31,34,39),leather=(60,64,70),instruments=(13,17,20),
              radio=(23,27,30),hvac=(25,29,33),speaker=(29,33,37),selector=(26,29,31))
