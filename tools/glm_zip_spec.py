...
# Pixel rectangles use a top-left image origin. The Blender builder converts
# them to OpenGL UV coordinates and keeps sampling away from region edges.
# Keep these semantic names in sync with the VehicleBuilder material names.
REGIONS = {
    ...
    "HEADLIGHT": (192, 168, 252, 190),
    "LENS_DARK": (192, 194, 252, 220),
    "GRIME": (4, 224, 100, 252),
