"""Shared model/atlas contract for both halves of the Vesper cooker."""

ATLAS_SIZE = 256

# Pixel rectangles use a top-left image origin. The Blender step converts them
# to OpenGL UV coordinates and applies a two-pixel sampling inset.
REGIONS = {
