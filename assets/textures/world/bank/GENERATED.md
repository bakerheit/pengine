...
Asset type: production-ready photorealistic game material texture for the enterable Pinatty Savings & Trust bank.
Primary request: A seamless square albedo texture of a polished late-1980s bank lobby terrazzo floor: warm ivory cement, fine restrained cream, charcoal and muted brass stone chips, subtle thin straight brass divider grid defining four equal square tiles. Photorealistic surface detail but diffuse only, no specular highlights, no reflections. Uniform scale. Perfectly orthographic overhead, edge-to-edge, tileable all four edges.
...
Use case: stylized-concept
Asset type: production-ready photorealistic game material texture for the enterable Pinatty Savings & Trust bank.
Primary request: A seamless square albedo texture of clean satin walnut veneer paneling for a late-1980s bank teller counter and interior wainscot. Warm medium honey-brown wood, fine vertical straight grain, evenly spaced narrow vertical panel seams. Restrained pores and natural grain variation, no heavy knots. Photorealistic diffuse material only, flat orthographic front view, edge-to-edge, tileable all four edges.
Constraints: one square image, no watermark, no presentation board, no mockup, no border outside the material, no baked directional shadows or lighting gradients.

## acoustic-ceiling.png

Use case: stylized-concept
Asset type: production-ready photorealistic game material texture for the enterable Pinatty Savings & Trust bank.
Primary request: A seamless square albedo texture showing exactly a 2 by 2 grid of clean ivory acoustic drop-ceiling tiles with thin pale aluminum T-grid seams. Fine irregular pinholes in mineral fiber, subtle realistic off-white variations, very light surface. Photorealistic diffuse texture, square orthographic view straight up, flat neutral lighting, perfectly edge-to-edge, tileable all four edges. No lamps, vents or perspective.
Constraints: one square image, no watermark, no presentation board, no mockup, no border outside the material, no baked directional shadows or lighting gradients.
...
Use case: stylized-concept
Asset type: production-ready photorealistic game material texture for the enterable Pinatty Savings & Trust bank.
Primary request: Seamless square albedo game texture of a late-1980s bank safe-deposit wall: exactly 4 columns by 6 rows of small rectangular brushed stainless steel doors, each with a tiny brass keyhole and restrained rectangular label holder. Clean polished but gently used, fine horizontal metal grain. Flat orthographic front elevation, subtle seam detail only, uniform neutral diffuse lighting, edge-to-edge and tileable all four edges. No readable text, no floor, no room, no perspective, no cast shadows.
Constraints: one square image, no watermark, no presentation board, no mockup, no border outside the material, no baked directional shadows or lighting gradients.
